        ...
        <div class="col-xl-4">
            ...
            <div class="card">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    <img src="{{ asset('assets/admin/img/profile-img.jpg') }}" class="rounded-circle"
                        style="width:120px; height:150px">
                    <h4 class="mt-1" style="font-family: sans-serif"><strong>{{ $data->name }}</strong></h4>
                    <h6 style="font-family: sans-serif">Junior Web Programming</h6>
                </div>
            </div>
                    ...
                    <div class="tab-content pt-2">
                        ...
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-lg-9 col-md-8">Junior Web Programming</div>
                            </div>
                        ...
                        <h6 class="fst-italic">{{ $data->description }}</h6>
